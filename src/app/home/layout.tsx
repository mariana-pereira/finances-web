  ...
  return (
    <html lang="pt-BR" className="dark antialiased">
      <body className={inter.className}>
        <div className="h-[100vh] flex flex-row dark:bg-zinc-900">
          <div className="h-[100vh] w-[20vw] bg-blue-900 rounded-tr-2xl flex flex-col items-center">
            ...
            <div className="w-[20vw] h-[80vh] bg-zinc-950 rounded-tr-2xl py-9">
          ...
          <main className="max-w-[80vw] lg:col-start-2 lg:px-8 lg:pt-8 bg-zinc-950">
            {children}
          </main>
        </div>
      </body>
